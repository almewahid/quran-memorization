...
export default function SignUpPage() {
  ...
  const handleGoogleSignUp = async () => {
    ...
    try {
      ...
      setError(error instanceof Error ? error.message : "حدث خطأ أثناء التسجيل عبر Google")
    } finally {
      ...
      <Card className="w-full max-w-md relative z-10 shadow-2xl border-0 bg-white/80 backdrop-blur-sm">
        <CardHeader className="text-center space-y-4 pb-8">
          ...
          <div>
            ...
            <CardDescription className="text-emerald-600 text-lg mt-2">
              أنشئ حسابك لبدء رحلة حفظ القرآن الكريم
            </CardDescription>
          </div>
        </CardHeader>
        ...
        <CardContent className="space-y-6">
          <Button
            type="button"
            variant="outline"
            className="w-full h-12 text-gray-700 border-2 hover:bg-gray-50 transition-all duration-200 bg-transparent"
          ...
          >
            ...
            {isGoogleLoading ? "جاري التحميل..." : "التسجيل عبر Google"}
          </Button>
          ...
          <form onSubmit={handleSignUp} className="space-y-5">
            <div className="space-y-2">
              <Label htmlFor="fullName" className="text-right block text-gray-700 font-medium">
                الاسم الكامل
              </Label>
              <div className="relative">
            ...
            <div className="space-y-2">
              ...
              <div className="relative">
                ...
                <Input
                  ...
                  className="text-right pr-12 pl-12 h-12 border-2 focus:border-emerald-500 transition-colors"
                />
                <button
                  type="button"
